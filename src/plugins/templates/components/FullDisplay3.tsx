...
import '../styles/FullDisplay3.css';
 ...
 */
const FullDisplay3 = ({ title, app1, app2, app3, backgroundColor, backgroundGradient, transition }: Props): JSX.Element => {
